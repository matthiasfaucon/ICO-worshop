...
export default function Home() {
    ...
    const { data: session } = useSession(); // Récupère la session active
            ...
            <div className="text-center">
                ...
                {session ? (
                    <p className="text-lg mb-6 max-w-lg mx-auto">
                        ...
                        <span className="font-bold text-yellow-400">{session.user?.email}</span>
                    </p>
                ) : (
                    <p className="text-lg mb-6 max-w-lg mx-auto">
                        Venez conquérir les océans avec votre équipage !
                    </p>
                )}
            </div>
